...
const hadith = ' “Women and perfume have been made dear to me, but my comfort has been provided in prayer.”'
const Hero = () => {
    ...
    <>
      <Box sx={{ bgcolor: '#1b4805', height: '300px', overflow: 'hidden' }}>
        <div className="relative w-full	h-full">
          ...
          >
            <Typography variant="caption">{hadithNarration}</Typography>
            <Typography variant="subtitle1">{hadith}</Typography>
            <Typography variant="caption">[Sunan an-Nasa'i 3940]</Typography>
            <Box>
              <Button
                variant="contained"
                disableTouchRipple
